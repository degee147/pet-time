...
import 'package:flutter_pets_project/screen/AdoptionThankYouPage.dart';
import 'package:flutter_pets_project/screen/CouponList.dart';
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              getCustomText(addressList.name, textColor, 1,
                                  TextAlign.center, FontWeight.w700, 14),
                              Padding(
                                ...
                                children: [
                                  Column(
                                    ...
                                    crossAxisAlignment:
                                        CrossAxisAlignment.start,
                                    children: [
                                      getCustomText(cardList.name, textColor, 1,
                                          TextAlign.start, FontWeight.w700, 12),
                                      Padding(
                                        padding: EdgeInsets.only(top: 2),
                                        child: getCustomText(
                                            cardList.email,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              getBookingDetailRow(S.of(context).checkin,"Wed 14 Oct,2020"),
                              getBookingDetailRow(S.of(context).checkout,"Fri 16 Oct,2020"),
                              getBookingDetailRow(S.of(context).serviceType,S.of(context).pickUp),
                              getCustomText(S.of(context).additionalTreatment, primaryTextColor, 1, TextAlign.start,
                                  FontWeight.w400, Constants.getPercentSize1(screenHeight, 1.8)),
                              Container(
                                width: double.infinity,
                                height: containerHeight,
                        ...
                        children: [
                          Expanded(
                            child: getCustomText(S.of(context).subTotal, primaryTextColor,
                                1, TextAlign.start, FontWeight.w600, 10),
                            flex: 1,
                          ),
