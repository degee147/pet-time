...
class _AddToCartPage extends State<AddToCartPage> {
  ...
  Widget build(BuildContext context) {
    ...
    double fontTitleSize=Constants.getPercentSize1(SizeConfig.safeBlockVertical*100,1.8);
    double fontDataTitleSize=Constants.getPercentSize1(SizeConfig.safeBlockVertical*100,1.5);
    double fontTotalTitleSize=Constants.getPercentSize1(SizeConfig.safeBlockVertical*100,1.9);
                  ...
                  child: Container(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return ListItem(imageSize, cartModelList[index], removeItem);
                        }),
                  ),
                  flex: 1,
                ),
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Expanded(
                            child: getCustomText(S.of(context).subTotal, primaryTextColor,
                                1, TextAlign.start, FontWeight.w500, fontTitleSize),
                            flex: 1,
                          ),
                          Expanded(
                            child: getCustomText("\$88.10", primaryTextColor, 1,
                                TextAlign.end, FontWeight.w500, fontDataTitleSize),
                            flex: 1,
                          )
                        ],
                      ),
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: getCustomText("\$9.90", primaryTextColor, 1,
                                  TextAlign.end, FontWeight.w500, fontDataTitleSize),
                              flex: 1,
                            )
                          ],
                     ...
                     Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: getCustomText("\$6.50", primaryTextColor, 1,
                                  TextAlign.end, FontWeight.w500, fontDataTitleSize),
                              flex: 1,
                            )
                          ],
                      ...
                      Row(
                        ...
                        children: [
                          Expanded(
                            child: getCustomText(S.of(context).total, textColor, 1,
                                TextAlign.start, FontWeight.bold, fontTotalTitleSize),
                            flex: 1,
                          ),
                          Expanded(
                            child: getCustomText("\$104.50", textColor,
                                1, TextAlign.end, FontWeight.bold, fontTotalTitleSize),
                            flex: 1,
                          )
                        ],
                      ),
                      InkWell(
                        child: Container(
                          ...
                          child: Center(
                            child: getCustomText(S.of(context).chekout, Colors.white, 1,
                                TextAlign.start, FontWeight.w900, Constants.getPercentSize(SizeConfig.safeBlockVertical*7,30)),
                          ),
                        ),
                        onTap: () {
                          Navigator.push(
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: AssetImage(Constants.assetsImagePath+ subCategoryModel.image[0]),
                                fit: BoxFit.cover
                              )
                            ),
                            // child: Image.asset(
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    getCustomText(subCategoryModel.name, textColor, 1, TextAlign.start,  FontWeight.bold, Constants.getScreenPercentSize(context, 2))
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Expanded(child:  getCustomText(subCategoryModel.priceCurrency+subCategoryModel.price.toString(), textColor,
                                              1, TextAlign.start,  FontWeight.w500, 15),
                                            flex: 1,),
                                                  ...
                                                  child: Center(
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          InkWell(
                                                            child: Container(
                                                              height: Constants.getScreenPercentSize(context, 3.5),
                                                              width: Constants.getScreenPercentSize(context, 3.5),
                                                              decoration: BoxDecoration(
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: getCustomTextWithoutAlign(subCategoryModel.quantity.toString(), primaryTextColor, FontWeight.w400, Constants.getScreenPercentSize(context, 1.5)),
