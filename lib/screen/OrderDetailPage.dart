            ...
            itemBuilder: (context, index) {
              return InkWell(
                child: Container(
                  ...
                  margin: EdgeInsets.all(Constants.getPercentSize(cellHeight,3)),
                  padding: EdgeInsets.symmetric(vertical:Constants.getPercentSize(cellHeight,3),horizontal: Constants.getPercentSize(cellHeight,13)),
                  height: cellHeight,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                getCustomText(
                                    myOrderList[index].priceCurrency+myOrderList[index].price.toString(),
                                    textColor,
                                    1,
                                    TextAlign.start,
                                    FontWeight.bold,
          ...
          body: Container(
            ...
            child: ListView(
              children: [
                ...
                onDelivery(),
                Padding(
                  padding: EdgeInsets.only(top:Constants.getPercentSize(totalHeight,2), bottom: Constants.getPercentSize1(totalHeight,0.7)),
                  child: getCustomTextWithoutMax(S.of(context).lorem_text,textColor,
                       TextAlign.start, FontWeight.w500, fontSizeLarge),
                ),
                getCustomText(
                ...
                Container(
                  height: 0.3,
                  color: subTextColor,
                  margin: EdgeInsets.only(bottom:Constants.getPercentSize1(totalHeight,0.8),top: Constants.getPercentSize(totalHeight,2)),
                  // margin: EdgeInsets.only(bottom: 15, top: 15),
                ),
                Row(
                  children: [
