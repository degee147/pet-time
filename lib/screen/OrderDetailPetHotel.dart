          ...
          body: Container(
            ...
            child: ListView(
              children: [
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: Container(
                            ...
                            height: imageSize,
                            child: Image.asset(
                              Constants.assetsImagePath + adoptionModel.image[0],
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                ...
                getCustomText(S.of(context).treatment, primaryTextColor, 1, TextAlign.start,
                    FontWeight.bold, Constants.getPercentSize1(totalHeight, 2)),
                Container(
                  width: double.infinity,
                  decoration: new BoxDecoration(
                      color: cardColor,
