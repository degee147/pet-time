              ...
              children: [
                ...
                InkWell(
                  child: Container(
                      ...
                      child: InkWell(
                        child: Center(
                          child:getCustomText(S.of(context).save, Colors.white, 1, TextAlign.start, FontWeight.w900, 15),
                        ),
                      )),
                  onTap: () {
      ...
      child: Row(
        ...
        children: [
          ...
          Padding(
            ...
            child:getCustomText(s, textColor, 1, TextAlign.start, FontWeight.bold, 12) 
           ,
          )
        ],
      ),
