...
import 'package:flutter_pets_project/screen/SubmitAdoptionForm.dart';
              ...
              child: Container(
                  ...
                  child: Container(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.of(context).push(MaterialPageRoute(builder: (context) => SubmitAdoptionForm(_modelProduct),));
                        },
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                                ...
                                child: Stack(children: [
                                  PageView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return Image.asset(
                                        Constants.assetsImagePath + _modelProduct.image[index],
                                        fit: BoxFit.cover,
                                        width: double.infinity,
                                        height: double.infinity,
                                      );
                  ...
                  body: Stack(
                    children: [
                      Transform(
                        ...
                        child: Image.asset(
                          Constants.assetsImagePath + _modelProduct.image[selectedIndex],
                          fit: BoxFit.cover,
                          width: double.infinity,
                          height: sliderHeight,
                        ),
