...
import 'package:flutter_pets_project/screen/AddNewPet.dart';
...
import 'package:flutter_pets_project/screen/AdoptionDetail.dart';
          ...
          children: [
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InkWell(
                          ...
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(builder: (context) => AdoptionDetail(_modelAdoption),));
                          },
                        );
                      })),
              flex: 1,
            ...
            Container(
              ...
              child: InkWell(
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(builder:(context) =>AddNewPet(),));
                },
              ),
            )
          ],
