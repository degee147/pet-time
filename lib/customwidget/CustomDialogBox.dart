      ...
      children: <Widget>[
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              getCustomText(widget.title, Colors.black, 1, TextAlign.center,FontWeight.w600,20)
              // Text(
              //   widget.title,
              ...
              getCustomText(widget.descriptions,Colors.black87,2,TextAlign.center,FontWeight.normal,14)
              // Text(
              //   widget.descriptions,
